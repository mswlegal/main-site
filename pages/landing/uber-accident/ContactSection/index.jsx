              ...
              <div className={cx(styles.card, 'card py-4 h-100')}>
                <div className="card-body text-center">
                  ...
                  <h4 className="text-uppercase m-0">
                    <Translate i18nKey="contact_info.address" ns="uberAccident" />
                  </h4>
            ...
            <Col md={4} className="mb-3 mb-md-0">
              <div className={cx(styles.card, 'card py-4 h-100')}>
                <div className="card-body text-center">
                  ...
                  <h4 className="text-uppercase m-0">
                    <Translate i18nKey="contact_info.email" ns="uberAccident" />
                  </h4>
                  <hr className="my-4 mx-auto" />
            ...
            <Col md={4} className="mb-3 mb-md-0">
              <div className={cx(styles.card, 'card py-4 h-100')}>
                <div className="card-body text-center">
                  ...
                  <h4 className="text-uppercase m-0">
                    <Translate i18nKey="contact_info.phone" ns="uberAccident" />
                  </h4>
                  <hr className="my-4 mx-auto" />
